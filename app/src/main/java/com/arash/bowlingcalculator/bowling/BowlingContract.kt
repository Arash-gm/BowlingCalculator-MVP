...
interface BowlingContract {
    ...
    interface View: BaseView<Presenter> {
        ...
        fun setResultSecondAttempt(isStrike: Boolean = false, isSpare:Boolean = false, score: Int = 0)
        fun setResultThirdAttempt(isStrike: Boolean = false, isSpare:Boolean = false, score: Int = 0)
        fun setResultLastFrame(total: Int)
        fun resetViews()
